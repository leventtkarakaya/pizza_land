...
const CartItem = ({ pizza }) => {
  const { removeItem, increaseAmount, decraseAmount } = useContext(CartContext);
  return (
      ...
      <div className="flex gap-x-4 mb-2">
        ...
        <div className="flex flex-col flex-1 gap-y-1">
          ...
          <div className="flex flex-col gap-y-1">
            ...
            <div className="flex items-center gap-x-1">
              {/* decrease quatity */}
              <div
                onClick={() => decraseAmount(pizza.id, pizza.price)}
        ...
        <div className="flex flex-col justify-between absolute right-0 h-[117px]">
          ...
          <div
            ...
            className="text-2xl flex items-center justify-center self-end cursor-pointer hover:scale-110 duration-100 transition-all text-orange"
          >
            <IoCloseOutline />
          </div>
          {/* price */}
